...
Créer un evenement et le deplacer par mois
    ...
    #on sassure que le bouton daffichage est present
    Wait Until Element Is Visible    ${btn_afficher_evenment} 
    #On attend que l'element "Journe Entiere" Soit visible                Le locator est pour sat-day12, sassure
        #davoir change le jour pour mon-tue-wed-thu-fri-sat-sun dans la locator
    Drag And Drop    ${btn_afficher_evenment}      ${btn_afficher_evenment2}day12${btn_afficher_evenment3}
    #clique sur Agenda
    Click Element    ${btn_Agenda}
    #on attend
    #Wait Until Element Is Visible    ${txt_auj}
    #on fait mouse over
