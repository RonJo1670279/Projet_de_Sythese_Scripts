*** Settings ***
Documentation    Test nominal de deplacement d'un evenement en mode Jour
...
Test Template     Créer un evenement et le deplacer par jour
...
cas5                    Test2    AUlit    Test1    1500    1800    adad